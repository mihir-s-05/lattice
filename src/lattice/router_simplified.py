...
class SimplifiedRouter:
    ...
    def run(self, goal: str) -> Dict[str, Any]:
        ...
        try:
            ...
            gate_results = mode_handler.evaluator.evaluate(mode_handler.gates)
            if all(g.status == "passed" for g in gate_results):
                ...
                missing = ["require all stage gates passed"]
                finalization_report = {"error": "finalization_blocked", "missing": missing}
